...
type CatalogFiltersUnifiedProps = {
  categories: string[];
    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
        ...
        >
          ...
          <label className="flex items-center gap-1 text-xs md:text-sm lg:text-base cursor-pointer text-gray-900 dark:text-white flex-shrink-0">
            <input
              type="checkbox"
          ...
          {/* Fade izquierda */}
          <div className="absolute left-0 top-0 h-full w-6 bg-gradient-to-r from-white/80 dark:from-gray-900/80 to-transparent pointer-events-none" />
          {/* Fade derecha */}
          <div className="absolute right-0 top-0 h-full w-6 bg-gradient-to-l from-white/80 dark:from-gray-900/80 to-transparent pointer-events-none" />
        </motion.div>
      </div>
    </motion.div>
  );
...
export default CatalogFiltersUnified;
